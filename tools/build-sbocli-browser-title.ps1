...
$linkArgs = @(
    ...
    "-sEXPORTED_FUNCTIONS=['_main','_malloc','_free','_SBOP2_SetWebAdminMode','_SBOP2_SetWebAdminSelectedPartsID','_SBOP2_BrowserChatSetComposition','_SBOP2_BrowserChatCommitText','_SBOP2_BrowserSetPadKey']",
