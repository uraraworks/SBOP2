/// @file AdminWindow.h
/// @brief 管理者ウィンドウメインフレームクラス 定義ファイル
...
enum {
	...
	SCRIDADMIN_CHAR_MODIFY_SKILL,			// 選択キャラ情報編集[所持スキルの設定]
...
protected:
	...
	afx_msg void OnCharModifySkill();
