/// @file StateProcBase.h
/// @brief 状態処理基底クラス 定義ファイル
...
public:
	...
	virtual void DrawImGui(void) {}                                   // ImGuiウィジェット描画（ブラウザ版）
	virtual void DrawImGuiSub(int /*kind*/) {}                        // ImGuiウィジェット描画（ネイティブサブウィンドウ）
