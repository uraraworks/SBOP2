...
protected:
	AflThread m_thread;
	AflClassProc* m_paflClassCallBack;
	//Afl::Windows::AflAdviseTimer m_timerAdvise;
	Afl::Windows::AflMediaTimer m_timerAdvise;
...
/////////////////////////////////////////////////////////////////////////////
// AflMusic
class AflMusic : public AflMTimer
{
public:
...
protected:
	...
	UINT m_uDevice;
	AflMPlayData m_MidiData;
	AflMusicDevice m_MDevice;
};
