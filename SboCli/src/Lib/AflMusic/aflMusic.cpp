...
AflMTimer::AflMTimer()
{
	m_bActive = false;
	m_bEnable = true;
	m_paflClassCallBack = new AflClassProc(this,AFLPROC(AflMTimer,callProcess));
	m_thread.startThread(m_paflClassCallBack,0);
}
AflMTimer::~AflMTimer()
{
	m_bEnable = false;
	m_timerAdvise.release();
	delete m_paflClassCallBack;
}
DWORD AflMTimer::callProcess(LPVOID pvData)
{
...
bool AflMTimer::start(DWORD dwTime)
{
	m_timerAdvise.startTimer(dwTime*10000);
	m_bActive = true;
	return 0;
}
void AflMTimer::procTimer()
{
}
bool AflMTimer::isTimer()const
{
	return m_bActive;
}
...
void AflMExclusive::set(INT iCount,LPBYTE pData)
{
...
bool AflMusicDevice::openDirectMusic()
{
#ifndef _WFL_NONDMUSIC
	if(m_pDirectMusic)
	{
...
bool AflMusicDevice::setDLS(LPDWORD pData,INT iCount)
{
#ifndef _WFL_NONDMUSIC
	if(openDirectMusic())
	{
...
INT AflMusicDevice::getDeviceCount()const
{
	return midiOutGetNumDevs();
}
bool AflMusicDevice::isDevice()const
{
	return m_hMidi!=0;
}

void AflMusicDevice::setIdelTime(DWORD dwTime)
{
	m_dwIdelTime=dwTime;
}
...
BYTE AflMPlayData::CTrackData::getData()
{
	BYTE bbByte = *m_pByte;
	m_pByte++;
	return bbByte;
}
DWORD AflMPlayData::CTrackData::getNextCount()
{
	return m_dwNextCount;
}
void AflMPlayData::CTrackData::next()
{
	m_dwNextCount += getWait();
}
void AflMPlayData::CTrackData::setStep(INT nStep)
{
	m_dwNextCount-=nStep;
}
bool AflMPlayData::CTrackData::isPlay()const
{
	return m_pByte<m_pLastByte-1;
}
DWORD AflMPlayData::CTrackData::getWait()
{
	return protgetWaitCount(&m_pByte);
}
void AflMPlayData::CTrackData::setSkip()
{
	m_pByte += getWait();
}
void AflMPlayData::CTrackData::setSkip(DWORD dwSkip)
{
	m_pByte += dwSkip;
}
void AflMPlayData::CTrackData::init()
{
	m_dwNextCount = 0;
	m_pByte = (LPBYTE)m_pTHeader+8;
	m_pLastByte=m_pByte+protConvDW(m_pTHeader->dwBytes);
}
DWORD AflMPlayData::CTrackData::getStep()const
{
	return m_nStep;
}
DWORD AflMPlayData::CTrackData::getEStep()const
{
	return m_nEStep;
}
DWORD AflMPlayData::CTrackData::getMarkerSize()const
{
	return m_nMarker;
}
LPCSTR AflMPlayData::CTrackData::getString() const
{
	return (LPCSTR)m_pByte;
}
LPBYTE AflMPlayData::CTrackData::getAdr()
{
	return m_pByte;
}
...
void AflMPlayData::setTracks(CTrackData* pTData,INT nTracks)
{
	...
	m_dwStep = dwStep;
	if(dwExStep)
		m_pECode = new AflMExclusive[dwExStep];
...
//     
//---------------------------------------------------------
LPCSTR AflMPlayData::getTitle()const
{
	return m_pTitle;
}
//---------------------------------------------------------
//     
//---------------------------------------------------------
WORD AflMPlayData::getRCount()const
{
	return m_wRCount;
}
//---------------------------------------------------------
//     
//---------------------------------------------------------
DWORD AflMPlayData::getNextCount()const
{
...
//     
//---------------------------------------------------------
BYTE AflMPlayData::getCode()const
{
...
//     
//---------------------------------------------------------
DWORD AflMPlayData::getDWord()const
{
...
//     
//---------------------------------------------------------
BYTE AflMPlayData::getByte(INT iIndex)const
{
...
//     
//---------------------------------------------------------
LPMIDIHDR AflMPlayData::getEData()
{
...
//     
//---------------------------------------------------------
WORD AflMPlayData::getDataWord()const
{
...
//     
//---------------------------------------------------------
bool AflMPlayData::isPlay()const
{
...
//     
//---------------------------------------------------------
DWORDLONG AflMPlayData::getMarkLoopstart()const
{
...
//     
//---------------------------------------------------------
DWORDLONG AflMPlayData::getNowCount()const
{
	return m_dwlCount;
}
//---------------------------------------------------------
//     
//---------------------------------------------------------
DWORDLONG AflMPlayData::getAllCount()const
{
...
//     
//---------------------------------------------------------
DWORD AflMPlayData::getAllTime()const
{
	return m_dwAllTime;
}
//---------------------------------------------------------
//     
//---------------------------------------------------------
bool AflMPlayData::isData()const
{
	return m_pMCode!=0;
}
//---------------------------------------------------------
//     
//---------------------------------------------------------
LPSTR AflMPlayData::getMarker(INT nPoint)
{
...
//     
//---------------------------------------------------------
INT AflMPlayData::getDLSCount()const
{
	return m_nDLSCount;
}
//---------------------------------------------------------
...
bool AflMusic::open(HMODULE hResource, HRSRC hSrc,LPCSTR pType)
{
	...
	bool bFlag = stdMidi((BYTE *)LockResource (hRes), SizeofResource (hResource, hSrc));
...
//     
//---------------------------------------------------------
bool AflMusic::sendReset(INT nMode)
{
...
//     
//---------------------------------------------------------
bool AflMusic::playTime(DWORD dwTime)
{
	if(!isData())
		return false;
	insideInit();
...
//     
//---------------------------------------------------------
bool AflMusic::outMidiData(DWORD dwData)
{
...
//     
//---------------------------------------------------------
bool AflMusic::outMidiData(BYTE byData1,BYTE byData2,BYTE byData3)
{
...
//     
//---------------------------------------------------------
LPCSTR AflMusic::getTitle()const
{
...
//     
//---------------------------------------------------------
SGpPlayInfo* AflMusic::getPlayInfo()
{
	return &m_playInfo;
}
//---------------------------------------------------------
//     
//---------------------------------------------------------
WORD AflMusic::getTimeBase()const
{
...
//     
//---------------------------------------------------------
DWORDLONG AflMusic::getAllCount()const
{
...
//     
//---------------------------------------------------------
DWORDLONG AflMusic::getPlayCount()const
{
...
//     
//---------------------------------------------------------
DWORDLONG AflMusic::getAllTime()const
{
...
//     
//---------------------------------------------------------
DWORDLONG AflMusic::getPlayTime()const
{
	return m_dwNowTime + 
...
//     
//---------------------------------------------------------
void AflMusic::getDeviceName(INT nIndex,LPTSTR pString)
{
...
//     
//---------------------------------------------------------
UINT AflMusic::getTimerID()const
{
	return (UINT)isTimer();
}
//---------------------------------------------------------
...
//     
//---------------------------------------------------------
void AflMusic::setTimeCountBase()
{
...
//     
//---------------------------------------------------------
DWORD AflMusic::getTimeCountBase()
{
...
//     
//---------------------------------------------------------
bool AflMusic::stdMidi(const LPBYTE pData,INT nSize)
{
...
void AflMusic::setLoop(bool bLoop)
{
	m_bLoop=bLoop;
}
void AflMusic::setLoopTop(DWORDLONG dwlLoopSearch)
{
	m_dwlLoopSearch = dwlLoopSearch;
}
void AflMusic::setLoopTopTime(DWORD dwLoopSearch)
{
	m_dwLoopSearch = dwLoopSearch;
}
void AflMusic::setRelativeTemp(INT nRelativeTempo)
{
	setTemp(nRelativeTempo);
}
void AflMusic::setRelativeKey(char cKey)
{
	m_Relative.cKey = cKey;
}
void AflMusic::setRelativeVelocity(INT nVelo)
{
	m_Relative.nVelocity = nVelo;
}
void AflMusic::setRelativeVolume(INT nVolume)
{
...
void AflMusic::setRelativePan(INT nPan)
{
...
void AflMusic::setRelativeChorus(INT nChorus)
{
...
void AflMusic::setRelativeReverb(INT nReverb)
{
