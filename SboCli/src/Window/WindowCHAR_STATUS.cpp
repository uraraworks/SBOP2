...
void CWindowCHAR_STATUS::Draw(PCImg32 pDst)
{
	...
	TextOut2 (hDC, 12 + 5, 7 + 4, _T("キャラ情報(J)"), RGB (255, 255, 255));
	y = 8 * 3;
	...
	TextOut2 (hDC, x + 5, y + 2, _T("名前"), RGB (255, 255, 255));
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)pInfoChar->m_strCharName, RGB (1, 1, 1));
	y += 18;
	DrawFrame (x, y, 120, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("職業"), RGB (255, 255, 255));
	x = 12 + 8 * 16;
	DrawFrame (x, y, 56, 16, 6);
	DrawFrame (x, y, 32, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("LV"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_wLevel);
	TextOut2 (hDC, x + 27, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	y += 18;
	x = 12;
	DrawFrame (x, y, 184, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("所属"), RGB (255, 255, 255));

	y = 8 * 11 + 7;
	x = 12;
	DrawFrame (x, y, 48, 24, 7);
	TextOut2 (hDC, x + 5, y + 4, _T("基本値"), RGB (255, 255, 255));
	y += 16;
	DrawFrame (4, y, 200, 64, 6);
	y += 6;
	x = 12;
	...
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 3, y + 2, _T("HP"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_dwMaxHP);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 3, y + 2, _T("MP"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("力"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_wPower);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("魔力"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("体力"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_wStrength);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("器用"), RGB (255, 255, 255));
	...
	TextOut2 (hDC, x + 5, y + 4, _T("ステータス"), RGB (255, 255, 255));
	y += 16;
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("攻撃"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_wPAtack);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("防御"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("攻術"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_wAbillityAT);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("防術"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("魔攻"), RGB (255, 255, 255));
	strTmp.Format(_T("%d"), pInfoChar->m_wPMagic);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("魔防"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("命中"), RGB (255, 255, 255));
	strTmp.Format(_T("%d%%"), pInfoChar->m_wPHitAverage);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("回避"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5, y + 2, _T("必殺"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("火"), RGB (255, 255, 255));
	strTmp.Format(_T("%d%%"), pInfoChar->m_wAttrFire);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("水"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("風"), RGB (255, 255, 255));
	strTmp.Format(_T("%d%%"), pInfoChar->m_wAttrWind);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("土"), RGB (255, 255, 255));
	...
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("光"), RGB (255, 255, 255));
	strTmp.Format(_T("%d%%"), pInfoChar->m_wAttrLight);
	TextOut2 (hDC, x + 35, y + 2, (LPCTSTR)strTmp, RGB (1, 1, 1));
	x = 12 + 8 * 12;
	DrawFrame (x, y, 8 * 11, 16, 6);
	DrawFrame (x, y, 40, 16, 7, TRUE);
	TextOut2 (hDC, x + 5 + 6, y + 2, _T("闇"), RGB (255, 255, 255));
...
#if 0
	y = 0;
	TextOut2 (hDC, 16, 12 + 12 * y, (LPCTSTR)pInfoChar->m_strCharName, clText);
	y ++;
	strTmp = "レベル";
	TextOut2 (hDC, 16, 16 + 12 * y, (LPCTSTR)strTmp, clText);
	strTmp.Format(_T("%d"), pInfoChar->m_wLevel);
	TextOut2 (hDC, 16 + 12 * 7, 16 + 12 * y, (LPCTSTR)strTmp, clText);
	y ++;
	strTmp = "HP";
	TextOut2 (hDC, 16, 16 + 12 * y, (LPCTSTR)strTmp, clText);
