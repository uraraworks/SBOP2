...
void CWindowCHAR_STATUS2::Draw(PCImg32 pDst)
{
	...
	y = 0;
	strTmp = "スタミナ";
	TextOut2(m_pDib, FONTID_PGOTHIC_12_NORMAL, 16, 12 + 12 * y, (LPCTSTR)strTmp, clText);
	strTmp.Format(_T("%d"), pInfoChar->m_wStamina);
	TextOut2(m_pDib, FONTID_PGOTHIC_12_NORMAL, 16 + 12 * 7, 12 + 12 * y, (LPCTSTR)strTmp, clText);
	y ++;
	strTmp = "腕力";
	TextOut2(m_pDib, FONTID_PGOTHIC_12_NORMAL, 16, 12 + 12 * y, (LPCTSTR)strTmp, clText);
