...
protected:
	...
	void TextOut2(CImg32 *pDst, int nFontId, int x, int y, LPCTSTR pStr, COLORREF Color, BOOL bDraw = FALSE, COLORREF ColorFrame = RGB(10, 10, 10));	// SDL_ttf版 黒縁取りで文字描画
	void TextOut3(CImg32 *pDst, int nFontId, int x, int y, int cx, int cy, LPCTSTR pStr, COLORREF Color);	// SDL_ttf版 黒縁取りで文字描画(右詰)
	void TextOut4(CImg32 *pDst, int nFontId, int x, int y, LPCTSTR pStr, COLORREF ColorFrame, COLORREF Color = RGB(255, 255, 255));	// SDL_ttf版 黒縁取りで文字描画
