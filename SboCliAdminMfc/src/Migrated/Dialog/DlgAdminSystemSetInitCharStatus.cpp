/// @file DlgAdminSystemSetInitCharStatus.cpp
/// @brief キャラステータス初期値の設定ダイアログクラス 実装ファイル
...
CDlgAdminSystemSetInitCharStatus::CDlgAdminSystemSetInitCharStatus(CWnd* pParent)
