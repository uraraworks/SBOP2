/// @file PacketCHAR_MOVE_START.h
/// @brief コマンド(キャラ系:移動開始通知) 定義ファイル
/// @date 2026/02/28
...
public:
	...
	virtual ~CPacketCHAR_MOVE_START() {}
	...
	void Make(DWORD dwMapID, DWORD dwCharID, int nDirection, int x, int y, BOOL bUpdate, int nSpeedLevel, DWORD dwTimeStamp)
	{
		...
		pPacketBase->byCmdSub = SBOCOMMANDID_SUB_CHAR_MOVE_START;
...
public:
	...
	int m_nSpeedLevel;
	DWORD m_dwTimeStamp;
} CPacketCHAR_MOVE_START, *PCPacketCHAR_MOVE_START;
