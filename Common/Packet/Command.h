...
enum {
	...
	SBOCOMMANDID_SUB_CONNECT_REQ_LOGIN_TOKEN,	// 端末トークンログイン要求
};
...
enum {
	...
	SBOCOMMANDID_SUB_ACCOUNT_REQ_DELETECHAR,	// キャラ削除要求
	SBOCOMMANDID_SUB_ACCOUNT_RES_DELETECHAR,	// キャラ削除応答
};
...
enum {
	...
	SBOCOMMANDID_SUB_ADMIN_MAP_SELECTPICK,		// マップ選択ピック
	SBOCOMMANDID_SUB_ADMIN_MAP_SELECTCLEAR,		// マップ選択解除
};
