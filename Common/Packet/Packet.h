...
#include "ACCOUNT/PacketACCOUNT_REQ_DELETECHAR.h"	// キャラ削除要求
#include "ACCOUNT/PacketACCOUNT_RES_DELETECHAR.h"	// キャラ削除応答
...
#include "ADMIN/PacketADMIN_MAP_SELECTPICK.h"		// マップ選択ピック
#include "ADMIN/PacketADMIN_MAP_SELECTCLEAR.h"		// マップ選択解除
