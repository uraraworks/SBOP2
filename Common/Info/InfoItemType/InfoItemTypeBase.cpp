/// @file InfoItemTypeBase.cpp
/// @brief アイテム種別基底情報クラス 実装ファイル
...
DWORD CInfoItemTypeBase::GetDataSize(void)
{
	...
	dwRet += (m_strName.GetLegacyStoreLength() + 1);	// アイテム名
...
DWORD CInfoItemTypeBase::GetDataSizeNo(int nNo)
{
	...
	case 8:	dwRet = (m_strName.GetLegacyStoreLength() + 1);	break;	// アイテム名
