/// @file InfoTalkEventBase.h
/// @brief 会話イベント情報基底クラス 定義ファイル
...
using ARRAYTALKEVENTBASEINFO = CStdArray<PCInfoTalkEventBase>;
using PARRAYTALKEVENTBASEINFO = ARRAYTALKEVENTBASEINFO *;
