/// @file InfoMapObjectData.h
/// @brief マップオブジェクト配置データクラス 定義ファイル
...
using ARRAYMAPOBJECTDATAINFO = CStdArray<PCInfoMapObjectData>;
using PARRAYMAPOBJECTDATAINFO = ARRAYMAPOBJECTDATAINFO *;
