/// @file InfoItemWeapon.cpp
/// @brief アイテム武器情報クラス 実装ファイル
...
DWORD CInfoItemWeapon::GetDataSize(void)
{
	...
	dwRet += (m_strName.GetStoreLength() + 1);	// 武器種別名
...
DWORD CInfoItemWeapon::GetDataSizeNo(int nNo)
{
	...
	case 4:	dwRet = (m_strName.GetStoreLength() + 1);	break;	// 武器種別名
...
PBYTE CInfoItemWeapon::GetWriteData(int nNo, PDWORD pdwSize)
{
	...
	*pdwSize	= dwSize;
	...
	case 4:	pSrc = (PBYTE)m_strName.GetUtf8Pointer();	break;	// 武器種別名
