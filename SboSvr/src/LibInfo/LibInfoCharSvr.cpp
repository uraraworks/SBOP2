...
BOOL CLibInfoCharSvr::CheckMapEvent(CInfoCharSvr *pInfoChar)
{
	...
	case MAPEVENTTYPE_MOVE:			/* マップ内移動 */
		{
			PCInfoMapEventMOVE pInfoMapEvent = (PCInfoMapEventMOVE)pInfoMapEventBase;
	...
	case MAPEVENTTYPE_MAPMOVE:		/* マップ間移動 */
		{
			PCInfoMapEventMAPMOVE pInfoMapEvent = (PCInfoMapEventMAPMOVE)pInfoMapEventBase;
	...
	case MAPEVENTTYPE_INITSTATUS:	/* ステータス初期化 */
		{
			PCInfoMapEventINITSTATUS pInfoMapEvent = (PCInfoMapEventINITSTATUS)pInfoMapEventBase;
