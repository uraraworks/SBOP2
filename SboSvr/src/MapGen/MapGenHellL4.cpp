...
// 再帰フラッドフィル
void FloodFill(const L4Context &ctx, int x, int y, std::vector<bool> &visited, int &count)
{
...
bool IsConnected(const L4Context &ctx)
{
